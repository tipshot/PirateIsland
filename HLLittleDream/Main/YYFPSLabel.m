...
//                weakSelf.hl_x = (weakSelf.hl_x - KScreenWidth * 0.5) > 0 ? (KScreenWidth - weakSelf.hl_width - 20) : 20;
//                weakSelf.hl_y = weakSelf.hl_y > 80 ? weakSelf.hl_y : 80;
//            }];
//        }
//
//    }]];
...
- (void)GRAction:(UIPanGestureRecognizer*)sender{
    ...
    self.transform = CGAffineTransformTranslate(weakSelf.transform, transP.x, transP.y);
